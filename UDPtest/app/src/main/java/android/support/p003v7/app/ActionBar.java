...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            super(c, attrs);
            this.gravity = 0;
            TypedArray a = c.obtainStyledAttributes(attrs, C0268R.styleable.ActionBarLayout);
            this.gravity = a.getInt(C0268R.styleable.ActionBarLayout_android_layout_gravity, 0);
            a.recycle();
        }
