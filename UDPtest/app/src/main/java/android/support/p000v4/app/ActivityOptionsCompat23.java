...
class ActivityOptionsCompat23 {
    ...
    public static ActivityOptionsCompat23 makeCustomAnimation(Context context, int i, int i2) {
        ...
        int i3 = enterResId;
        int i4 = exitResId;
        return new ActivityOptionsCompat23(ActivityOptions.makeCustomAnimation(context2, enterResId, exitResId));
    }
    ...
    public static ActivityOptionsCompat23 makeSceneTransitionAnimation(Activity activity, View view, String str) {
        ...
        return new ActivityOptionsCompat23(ActivityOptions.makeSceneTransitionAnimation(activity2, sharedElement, sharedElementName));
    }
    ...
    public static ActivityOptionsCompat23 makeSceneTransitionAnimation(Activity activity, View[] viewArr, String[] strArr) {
        ...
        return new ActivityOptionsCompat23(ActivityOptions.makeSceneTransitionAnimation(activity2, pairs));
    }
    ...
    public void update(ActivityOptionsCompat23 activityOptionsCompat23) {
        ActivityOptionsCompat23 otherOptions = activityOptionsCompat23;
        ActivityOptionsCompat23 activityOptionsCompat232 = otherOptions;
